...
#     }
    ...
    res <- GWAS(Y=yvar, X=X, Z=Z, R=R,W=W, method=method, init=init,
                ...
                forced=forced,restrained=torestrain,
                
                P3D=P3D, models=models, ploidy=ploidy, min.MAF=min.MAF, 
                gwas.plots=gwas.plots, map=map,manh.col=manh.col,
                fdr.level=fdr.level, n.PC=n.PC)
